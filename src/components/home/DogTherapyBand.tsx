    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
        <div className="flex-1 text-center md:text-left">
          ...
          <h2 id="dog-therapy-title" className="text-2xl sm:text-3xl font-bold tracking-tight mb-4">
            Terapia Assistida por Cão
          </h2>
          <p className="text-white/90 leading-relaxed mb-6 max-w-xl">
            Sessões com o auxílio de cão terapeuta, potencializando vínculo, motivação e ganhos emocionais e sociais para crianças e famílias.
          </p>
