...
export default function ComplementaryCareSection() {
  return (
    <section className="py-20 sm:py-24 px-4 sm:px-6 bg-pastel-mint/70 border-t border-primary/[0.06] relative overflow-hidden" aria-labelledby="complementary-title">
